...
class GeneralUnetrUpBlock(nn.Module):
    """
    UnetrUpBlock with different upsampling modes
    """
    ...
    def __init__(
        ...
        scale_factor: float | Sequence[float] = 2.0,
    ) -> None:
        """
        Args:
            spatial_dims: number of spatial dimensions.
        ...
        super().__init__()
        upsample_mode = UpsampleMode(upsample_mode)
        interpolate_mode = InterpolateMode(interpolate_mode)
